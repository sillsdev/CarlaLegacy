...
namespace SIL.PcPatrBrowser
{
	...
	public class LanguageInfo : Object
	{
		...
		public string NTColorName
		{
			get
			{
				return m_mfiNT.ColorName;
			}
			set
			{
				m_mfiNT.ColorName = value;
			}
		}
		/// <summary>
		...
		public string NTFontFace
		{
			get
			{
				return m_mfiNT.FontFace;
			}
			set
			{
				m_mfiNT.FontFace = value;
			}
		}
		/// <summary>
		...
		public float NTFontSize
		{
			get
			{
				return m_mfiNT.FontSize;
			}
			set
			{
				m_mfiNT.FontSize = value;
			}
		}
		/// <summary>
		...
		public FontStyle NTFontStyle
		{
			get
			{
				return m_mfiNT.FontStyle;
			}
			set
			{
				m_mfiNT.FontStyle = value;
			}
		}
		/// <summary>
		...
		public string LexColorName
		{
			get
			{
				return m_mfiLex.ColorName;
			}
			set
			{
				m_mfiLex.ColorName = value;
			}
		}
		/// <summary>
		/// Gets/sets Lex info.
		...
		public string LexFontFace
		{
			get
			{
				return m_mfiLex.FontFace;
			}
			set
			{
				m_mfiLex.FontFace = value;
			}
		}
		/// <summary>
		...
		public float LexFontSize
		{
			get
			{
				return m_mfiLex.FontSize;
			}
			set
			{
				m_mfiLex.FontSize = value;
			}
		}
		/// <summary>
		...
		public FontStyle LexFontStyle
		{
			get
			{
				return m_mfiLex.FontStyle;
			}
			set
			{
				m_mfiLex.FontStyle = value;
			}
		}
		/// <summary>
		...
		public string GlossColorName
		{
			get
			{
				return m_mfiGloss.ColorName;
			}
			set
			{
				m_mfiGloss.ColorName = value;
			}
		}
		/// <summary>
		...
		public string GlossFontFace
		{
			get
			{
				return m_mfiGloss.FontFace;
			}
			set
			{
				m_mfiGloss.FontFace = value;
			}
		}
		/// <summary>
		...
		public float GlossFontSize
		{
			get
			{
				return m_mfiGloss.FontSize;
			}
			set
			{
				m_mfiGloss.FontSize = value;
			}
		}
		/// <summary>
		...
		public FontStyle GlossFontStyle
		{
			get
			{
				return m_mfiGloss.FontStyle;
			}
			set
			{
				m_mfiGloss.FontStyle = value;
			}
		}
		/// <summary>
