...
{
public:
	static LPCTSTR ID() {return "AMPLEDOS";}
	...
	virtual LPCTSTR getDisplayName() const { return "AMPLE EXE";}
...
public:
	...
	static LPCTSTR ID() {return "INTERGENDOS";}
	static LPCTSTR INPUT_TYPE_DISPLAY() {return "ANA";}
	static LPCTSTR OUTPUT_TYPE_DISPLAY() {return "Interlinear Text";}
	virtual LPCTSTR  getProcessorID() const {return ID();}
	virtual LPCTSTR getDisplayName() const { return "INTERGEN";}
	virtual void readParametersFromSFMFile(SFMFile *f) ;
