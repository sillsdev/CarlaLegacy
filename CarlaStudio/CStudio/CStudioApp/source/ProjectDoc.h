...
//	CTypedPtrArray<CPtrArray, CCarlaLanguage*> m_pLanguages;
	...
	CString fromRelativePath(const char* dir, const char* partialPath);
	CString toRelativePath(const char* dir, const char* fullPath);
...
public:
	...
	static CString getRegFileTypeID() {return "CarlaStudioProject";}
