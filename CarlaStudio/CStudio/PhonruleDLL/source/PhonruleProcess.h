...
public:
	...
	// Interface
	static LPCTSTR INPUT_TYPE_DISPLAY() {return "Dictionary";}
	static LPCTSTR OUTPUT_TYPE_DISPLAY() {return "Dictionary";}

	static LPCTSTR ID() {return "PHONRULEDLL";}
	virtual LPCTSTR  getProcessorID() const {return ID();}
	virtual LPCTSTR getDisplayName() const { return PHONRULEDISPLAYNAME;}
