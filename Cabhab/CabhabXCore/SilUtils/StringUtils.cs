...
namespace SIL.Utils
{
	...
	public static class StringUtils
	{
		...
		{
		//    return LongestUsefulCommonSubstring(s1, s2, -1, wholeWordOnly, out foundWholeWords);
		//}
		...
		///// <returns></returns>
		///// ------------------------------------------------------------------------------------
		//public static string LongestUsefulCommonSubstring(string s1, string s2, int maxLength,
		//    bool wholeWordOnly, out bool foundWholeWords)
		//{
			...
			//if (maxLength < 0)
			//    maxLength = Math.Min(s1.Length, s2.Length);
