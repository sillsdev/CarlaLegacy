...
//		}
		...
		protected Assembly GetAdapterAssembly()
		{
		...
		{
			bool useExtantPrefs = true; // Start optimistically.
			...
			if (Control.ModifierKeys != Keys.Shift) // Holding shift key means don't use extant preference file, no matter what.
			{
