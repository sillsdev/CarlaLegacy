...
//habby using SIL.FieldWorks.Resources;
using SIL.Utils;

namespace SIL.Cabhab.CabhabUtils
{
	/// <summary>
	...
	public static class DirectoryFinder
	{
		...
		/// </summary>
		public const string ksTeFolderName = "I don't care"; //FwUtils.ksTeAppName;
		/// <summary>
		...
		/// </summary>
		public const string ksFlexFolderName = "I don't care"; //FwUtils.ksFlexAppName;
		...
		{
			get { return CommonAppDataFolder("Cabhab"); }
		}
#if Needed
		/// ------------------------------------------------------------------------------------
		/// <summary>
	...
	public class DirectoryFinderRelativePaths
	{
		...
		public static String GetLinkedFilesFullPathFromRelativePath(string relativePath, String projectPath)
		{
			...
			fullPath = GetFullPathForRelativePath(relativePath, ksProjectRelPath,
								   projectPath);
