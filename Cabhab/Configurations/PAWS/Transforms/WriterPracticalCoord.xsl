...
<xsl:template match="/" mode="coord">
  <section1 id="sCoord">
    ...
    <p>
<xsl:text>This section considers basic coordination constructions where there is an overt conjunction between two conjuncts which are at the same level.  This includes coordination at the sentence level and at the verb phrase, nominal phrase, and adjective level.</xsl:text>
</p>
      <p>
