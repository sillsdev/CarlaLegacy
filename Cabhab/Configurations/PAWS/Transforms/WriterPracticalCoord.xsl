...
<xsl:template match="/" mode="coord">
  <section1 id="sCoord">
	...
	<p>
<xsl:text>This section considers basic coordination constructions where there is an overt conjunction between two conjuncts which are at the same level.  This includes coordination at the sentence level and at the verb phrase, nominal phrase, prepositional and/or postpositional phrase, and adjective phrase level.</xsl:text>
</p>
	  <p>
...
<xsl:call-template name="DoFree" />
		...
		<section2 id="sCoordDP">
			...
			<p>
<xsl:text>Coordinate nominal phrases can usually appear in all the positions where a regular nominal phrase may occur, such as subjects, objects, indirect objects, and objects of prepositions.  Nominal phrase coordination is exemplified in the following English sentences: </xsl:text>
</p>
			<ol>
				<li>
...
<xsl:call-template name="DoFree" />
	  ...
	  <section2 id="sCoordPP">
		  ...
		  <p>
<xsl:text>English examples of prepositional phrase coordination include: </xsl:text>
</p>
		  <ol>
			  <li>
				  <xsl:text>Bill ran through the forest and over the bridge.</xsl:text>
			  </li>
			  <li>
				  <xsl:text>I will come with you to the rehearsal but not back home.</xsl:text>
			  </li>
			  <li>
				  <xsl:text>I will come either to the wedding or to the reception.</xsl:text>
			  </li>
		  </ol>
		  <p>
<xsl:text></xsl:text>
...
<xsl:variable name="iExampleLength" select="normalize-space(string-length(//coord/coordppExample))" />
<xsl:choose>
<xsl:when test="$iExampleLength != 0 and $sExampleValue != ' '">
<xsl:call-template name="OutputInterlinearExamples">
<xsl:with-param name="sExamples">
...
<xsl:with-param name="iLength">
<xsl:value-of select="string-length(//coord/coordppExample)" />
</xsl:with-param>
...
<xsl:call-template name="DoFree" />
	  ...
	  <section2 id="sCoordAdj">
			...
			<p>
<xsl:text>Adjective phrase coordination is exemplified in the following English sentences: </xsl:text>
</p>
			<ol>
				<li>
				...
				<li>
					<xsl:text>The sore on your leg is very ugly and painful and dangerous.</xsl:text>
				</li>
				<li>
