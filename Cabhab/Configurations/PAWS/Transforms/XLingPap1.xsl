...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!-- ===========================================================
	  ...
	  =========================================================== -->
	<xsl:variable name="sVersion">1.11.0</xsl:variable>
	<!-- ===========================================================
	  Keys
	  =========================================================== -->
...
-->
	<xsl:template name="OutputGlossaryLabel">
		<xsl:call-template name="OutputLabel">
			...
			<xsl:with-param name="pLabel" select="//glossary/@label"/>
		</xsl:call-template>
	</xsl:template>
	<!--
				   OutputIndexLabel
