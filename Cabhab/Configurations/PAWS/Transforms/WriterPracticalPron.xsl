...
<xsl:text>.</xsl:text>
	...
	<section2 id="sPronNP">
		...
		<p>
<xsl:text>Pronouns normally stand alone in the place of an entire nominal phrase, but they can also be modified by a partitive phrase and in some languages pronouns may be modified by determiners and quantifiers.
