...
<tr>
		...
		<section2 id="sIPProDrop">
			...
			<p>
<xsl:text>Some languages are called pro-drop languages because allow a subject and/or object to be missing or unexpressed in their normal syntactic position.  For example, in Spanish the normal way to say "I buy a book" is </xsl:text>
<langData>
