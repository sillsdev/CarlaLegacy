...
Let conj_prefix_neg                 be      &lt;head type prefix conj head infl polarity&gt;		= negative
Let conj_prefix_pl                be      &lt;head type prefix conj head agr number&gt;		= plural
Let conj_suffix	                be      &lt;head type suffix conj&gt;		= +
Let conj_suffix_neg                 be      &lt;head type suffix conj head infl polarity&gt; = negative
Let conj_suffix_pl                be      &lt;head type suffix conj head agr number&gt;		= plural
...
S = S_1 Conj S_2
		&lt;S head&gt; = &lt;S_2 head&gt;
		{&lt;S_1 head topicP&gt; = &lt;TopicP&gt;
		/&lt;S_2 head topicP&gt; = &lt;TopicP&gt;
		}
		&lt;Conj head type conjoins_IP&gt; = +
   ...
   <xsl:if test="normalize-space(//focus/@topic)='yes' and normalize-space(//coord/@conjWord)!='yes' and normalize-space(//coord/@conjPos)='before' or normalize-space(//focus/@topic)='yes' and normalize-space(//coord/@conjWord)!='yes' and normalize-space(//coord/@conjPos)='either'">
<xsl:text>
   ...
   <xsl:if test="normalize-space(//focus/@topic)='yes' and normalize-space(//coord/@conjWord)!='yes' and normalize-space(//coord/@conjPos)='after' or normalize-space(//focus/@topic)='yes' and normalize-space(//coord/@conjWord)!='yes' and normalize-space(//coord/@conjPos)='either'">
<xsl:text>
   ...
   <xsl:if test="normalize-space(//focus/@topic)='yes' and normalize-space(//coord/@conjWord)!='yes' and normalize-space(//coord/@conjPos)='other' or normalize-space(//focus/@topic)='yes' and normalize-space(//coord/@noConj)='yes'">
<xsl:text>
