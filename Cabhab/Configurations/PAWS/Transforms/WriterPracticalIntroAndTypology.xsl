...
<xsl:text>.  It is written as a practical grammar that should be useful for the language community as well as for documenting much of the language.</xsl:text>
</p>
		<p>
