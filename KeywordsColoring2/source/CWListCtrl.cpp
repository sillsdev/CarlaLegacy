...
//	m_imageList.Add(bmp, RGB(0,0,0));//RGB(255,255,255)/*mask color);
	...
	DeleteObject(hiconItem);
*/
	int ids[] = {IDI_GenericListItem0,
				IDI_MorphEnvironment,
				IDI_StringEnvironment,
				IDI_DisabledOverlay,
				IDI_Editable,
				IDI_STAMPFlag,
				IDI_GenericListItem1,
				IDI_GenericListItem2,
				IDI_SENTRANSLimit,
				IDI_SENTRANSBegin,
				IDI_SENTRANSEnd,
				IDI_SENTRANSRulesOn,
				IDI_SENTRANSRulesOff,
				IDI_CommentListItem,
				IDI_TestDataListItem,

#ifndef mr270a
				IDI_Bookmark,
				IDI_BookmarkAndDisabled

#endif // mr270a
				//IDI_BookmarkNext,
				//IDI_BookmarkPrevious,
				//IDI_BookmarkClearAll
	...
	for(int i=0; i< sizeof(ids); i++)
	{
		...
		int x = m_imageList.Add(hiconItem);
		DeleteObject(hiconItem);
	}
	...
	m_imageList.SetOverlayImage( 15,2);	// bookmark
	m_imageList.SetOverlayImage( 16,3);	// bookmark + disabled
