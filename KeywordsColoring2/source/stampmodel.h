...
class CStampTransferRule: public CWEnvironConstrainedRule
{
	...
	public:
		...
		CStampTransferRule() : m_iType(kSTRSub), m_sFrom(""), m_sTo(""), CWEnvironConstrainedRule(STAMP_TRANSFER_RULE_ENVIRONCOLUMN, TRUE) { m_lcComments.m_iShowInColumn = STAMP_TRANSFER_RULE_ENVIRONCOLUMN + 1;}
...
class CStampTransferExpressionList : public CWList
{
	public:
		...
		virtual CString getSecondaryEntryTypeDisplayName() const {return "Flag";};
...
class CStampLexChange: public CWEnvironConstrainedRule
{
	public:
		...
		CStampLexChange() : m_sFrom(""), m_sTo(""), CWEnvironConstrainedRule(kEnvironColumn, TRUE) { m_lcComments.m_iShowInColumn = kEnvironColumn+1;}
...
class CRegSoundChange: public CWEnvironConstrainedRule
{
	public:
		...
		CRegSoundChange() : m_sFrom(""), m_sTo(""), m_sRscIds(""), CWEnvironConstrainedRule(kEnvironColumn, TRUE) { m_lcComments.m_iShowInColumn = kEnvironColumn+1;}
#else
		enum{kEnvironColumn = 2};
		CRegSoundChange() : m_sFrom(""), m_sTo(""), CWEnvironConstrainedRule(kEnvironColumn, TRUE) { m_lcComments.m_iShowInColumn = kEnvironColumn+1;}
#endif // hab17a1
...
class CRegSoundChangeList : public CWList
{
	...
	protected:
		virtual const CString getDisplayName() const {return "Regular Sound Change";}
