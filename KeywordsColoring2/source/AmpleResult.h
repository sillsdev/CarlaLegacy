...
//		16-June2000 jdh add m_sCategory to morph
  ...
  const TCHAR kcDelim = '_';
	...
	class CAError : public CASimpleNode
	{
		...
		protected:
			virtual CString getTag() const {return "error";}
			CString m_sCode;
			CString m_sWord;
	};
	...
	class CAMorph : public CASimpleNode
	{
		...
		protected:
			CString m_sType;
			virtual CString getTag() const {return "morph";}
	};
	...
	class CAAnalysis : public CAComplexNode
	{
		public:
			...
			virtual ostream& writeXML(ostream &sout) const;
		protected:
			virtual CString getTag() const {return "analysis";}
	...
	class CAParse : public CAComplexNode
	{
		public:
			...
			virtual ostream& writeXML(ostream &sout) const;
		protected:
			virtual CString getTag() const {return "parse";}
	...
	class CAmpleResult : public CAComplexNode
	{
		...
		protected:
			virtual CString getTag() const {return "AResult";}
  ...
  class CAllo : public CASimpleNode
  {
	...
	protected:
		virtual CString getTag() const {return "allo";}
  };
  ...
  class CAlloResult : public CAComplexNode
  {
	...
	protected:
		virtual CString getTag() const {return "AlloResult";}
		CTypedPtrArray<CPtrArray, CANode*>  m_wordResults;
  };
  #endif // hab218
