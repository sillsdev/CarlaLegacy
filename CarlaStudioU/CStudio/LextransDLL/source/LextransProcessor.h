...
public:
	...
	static LPCTSTR OUTPUT_TYPE_DISPLAY() {return _T("ANA");}// removed "target ana" because andy says people use it for glossing, to

	static LPCSTR ID() {return "LEXTRANSDLL";}
	virtual LPCSTR  getProcessorID() const {return ID();}
	virtual LPCSTR getDisplayName() const { return LEXTRANSDISPLAYNAME;}
