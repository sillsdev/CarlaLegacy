...
{
	if(!theApp.getProject()->getHaveLanguages())
			AfxMessageBox(_T("You have run into a bug.  The copy constructor for CProcessingPrefs assumes there is at least one language installed, but your project does not appear to have one.  More error dialogs will follow this one."));
