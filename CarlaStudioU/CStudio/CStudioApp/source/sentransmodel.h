...
#ifndef hab17a1
		virtual CString getSecondaryEntryTypeDisplayName() const {return _T("Directive\tCtrl+L");};
#else // hab17a1
		virtual CString getSecondaryEntryTypeDisplayName() const {return _T("Directive");};
#endif // hab17a1
...
//	virtual const CString& getDisplayName() const;
		...
		CSentransTransferRule() : m_sFrom(_T("")), m_sTo(_T("")), CWEnvironConstrainedRule(SENTRANS_TRANSFER_RULE_ENVIRONCOLUMN, TRUE) { m_lcComments.m_iShowInColumn = SENTRANS_TRANSFER_RULE_ENVIRONCOLUMN + 1;}
