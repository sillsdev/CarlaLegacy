...
:	m_bCheckMorphnames(	0),
	...
	m_sOutputStyle (_T("Ana")) // jdh june 13 2000 add switch to get xml output from parseFile
{
}
...
//	throwIfError(sResult);
	...
	CString sResult;
	if(m_options.m_sOutputStyle == _T("AResult"))
	{
		ASSERTX(m_options.m_pathXMLOutputPath != _T(""));
