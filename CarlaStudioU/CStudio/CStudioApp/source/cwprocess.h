...
#ifndef rde269
#include "ProcessOutput.h"  // for CResultStream::kUnknownStatus
#endif  // rde269
...
public:
	...
	virtual LPCSTR  getProcessorID() const = 0;
...
#ifndef rde269
					int eIcon=CResultStream::kUnknownStatus/*CResultStream::kUnknownStatus will cause a search for error words*/
#else   // rde269
