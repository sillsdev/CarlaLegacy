...
m_pathAnalyzedANA(pathAnalyzedANA, _T(""),_T(""),IDB_ChooseFolder, IDS_SelectFolderPrompt, IDS_MSGCancelMeansDefault,  _T("DEFAULT"),CPathCtrl::kSelectFolder),
m_pathInterlinear(pathInterlinear, _T(""),_T(""),IDB_ChooseFolder, IDS_SelectFolderPrompt, IDS_MSGCancelMeansDefault,  _T("DEFAULT"),CPathCtrl::kSelectFolder),
m_pathTransferedANA(pathTransferedANA, _T(""),_T(""),IDB_ChooseFolder, IDS_SelectFolderPrompt, IDS_MSGCancelMeansDefault,  _T("DEFAULT"),CPathCtrl::kSelectFolder),
m_pathSynthesized(pathSynthesized, _T(""),_T(""),IDB_ChooseFolder, IDS_SelectFolderPrompt, IDS_MSGCancelMeansDefault,  _T("DEFAULT"),CPathCtrl::kSelectFolder)
{
