...
// Attributes
public:
	static CString getRegFileTypeID() {return _T("CarlaStudioLanguageDoc");}
...
public:
	...
	static CString getLangDocBeginMarker() {return _T("+LangDoc");}
	static CString getProjectDocMarker() {return _T("Lang");}
