...
class CAnalysisProcessSequence : public CProcessSequence
{
	public:
		...
		virtual CString getOpeningSFMMarker()  const {return _T("+AnalysisProcessSequence");}
		static CString OPENING_SFM_MARKER()  {return _T("+AnalysisProcessSequence");}
		virtual CString getClosingSFMMarker() const {return _T("-AnalysisProcessSequence");}
...
class CSynthesisProcessSequence : public CProcessSequence
{
	public:
		...
		virtual BOOL isValidSequence(CString& sInvalidMsg) const;
		virtual CString getFullName() const;
		virtual CString getOpeningSFMMarker() const {return _T("+SynthesisProcessSequence");}
		static CString OPENING_SFM_MARKER()  {return _T("+SynthesisProcessSequence");}
		virtual CString getClosingSFMMarker() const {return _T("-SynthesisProcessSequence");}
	protected:
...
class CInterlinearProcessSequence : public CProcessSequence
{
	public:
		...
		virtual BOOL isValidSequence(CString& sInvalidMsg) const;
		virtual CString getFullName() const;
		virtual CString getOpeningSFMMarker() const {return _T("+InterlinearProcessSequence");}
		static CString OPENING_SFM_MARKER()  {return _T("+InterlinearProcessSequence");}
		virtual CString getClosingSFMMarker() const {return _T("-InterlinearProcessSequence");}
	protected:
...
//		void create (CCarlaLanguage* pTargetLang);
		...
		virtual CString getOpeningSFMMarker() const {return _T("+TransferProcessSequence");}
		static CString OPENING_SFM_MARKER()  {return _T("+TransferProcessSequence");}

		virtual CString getClosingSFMMarker() const {return _T("-TransferProcessSequence");}
	protected:
		virtual void readFromFile(SFMFile& f);
