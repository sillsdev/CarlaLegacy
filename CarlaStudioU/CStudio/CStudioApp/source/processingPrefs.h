...
{
public:
	static LPCTSTR BEGIN_MARKER() {return _T("+SrcProcessingPrefs");}
...
protected:
	...
	virtual CString getEndMarker() const {return _T("-SrcProcessingPrefs");}
...
{
public:
	static LPCTSTR BEGIN_MARKER() {return _T("+AnaProcessingPrefs");}
...
protected:
	...
	virtual CString getEndMarker() const {return _T("-AnaProcessingPrefs");}
	virtual CString getBeginMarker() const {return BEGIN_MARKER();}
