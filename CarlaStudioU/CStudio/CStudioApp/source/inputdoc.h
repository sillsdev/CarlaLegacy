...
public:
	...
	virtual CString getBeginMarker() const {return _T("+ERROR");} // should be = 0;
	virtual CString getEndMarker() const {return _T("-ERROR");}// should be = 0;
...
public:
	...
	static CString getRegFileTypeID() {return _T("CarlaStudioSourceDoc");}
	static CString BEGIN_MARKER() {return _T("+SrcTextInputDoc");}
	static CString END_MARKER() {return _T("-SrcTextInputDoc");}
	virtual CString getBeginMarker() const {return _T("+SrcTextInputDoc");}
	virtual CString getEndMarker() const {return _T("-SrcTextInputDoc");}
...
public:
	...
	static CString getRegFileTypeID() {return _T("CarlaStudioANADoc");}
	static CString BEGIN_MARKER() {return _T("+ANAInputDoc");}
	static CString END_MARKER() {return _T("-ANAInputDoc");}
	virtual CString getBeginMarker() const {return _T("+ANAInputDoc");}
	virtual CString getEndMarker() const {return _T("-ANAInputDoc");}
	virtual void readParams(SFMFile& f);
// Operations
public:
