// GuruSplash.cpp: implementation of the CGuruSplash class.
//
//////////////////////////////////////////////////////////////////////
...
CGuruSplash::CGuruSplash(UINT nBitmapID, UINT nDuration /*= 2500*/)
{
	m_nBitmapID = nBitmapID;
	m_nDuration = nDuration;
}

BEGIN_MESSAGE_MAP(CGuruSplash, CWnd)
	//{{AFX_MSG_MAP(CGuruSplash)
	ON_WM_PAINT()
	ON_WM_TIMER()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
BOOL CGuruSplash::GetBitmapAndPalette(UINT nIDResource, CBitmap &bitmap, CPalette &pal)
{
...
void CGuruSplash::OnTimer(UINT nIDEvent)
{
...
BOOL CGuruSplash::PreTranslateMessage(MSG* pMsg)
{
	ASSERT(pMsg != NULL);
