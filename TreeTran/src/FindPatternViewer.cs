//**************************************************************************
// File: "TreeTran\FindPatternViewer.cs".
//
// This file defines the FindPatternViewer class, which implements a control
// that allows the user to view and edit the find-pattern tree of a transfer
// rule.
//
// History:
//     2006-Aug-24 David Bullock: Code complete.
//**************************************************************************
using System;
...
namespace TreeTranViewer
{
	...
	/// find-pattern tree of a transfer rule.
	/// </summary>
	public class FindPatternViewer: System.Windows.Forms.UserControl
	{
		//******************************************************************
