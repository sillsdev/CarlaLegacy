/* STRCASEC.C - compare two ASCII strings ignoring case distinctions
 *****************************************************************************
 *
 * int strcasecmp(char * pszString1_in, char * pszString2_in)
 *
 *****************************************************************************
...
#ifdef __STDC__
int strcasecmp(const char * pszString1_in, const char * pszString2_in);
#endif
 ...
 *
 */
int strcasecmp(pszString1_in,pszString2_in)
