...
namespace LingTree
{
	...
	public class LingTreeTree : Control //Object
	{
		...
		public LingTreeTree(string sVersion)
			...
			Color.Green, Color.Blue, Color.Black, Color.Black, 10.0, sVersion)
		{
		}
		...
		public void Draw(Graphics grfx, Color color)
		{
			...
			{
				grfx.DrawString(MessageText, new Font("Times New Roman", 9.0f), new SolidBrush(SystemColors.WindowText), 2.0f, 2.0f);
			}
		}
		...
		void ThrowUnmatchedClosingParenException(string sIllFormed,
			string sDescription,
			int iPos)
		{
		...
		public bool UseRightToLeft
		{
			get
			{
				return m_bUseRightToLeft;
			}
			set
			{
				m_bUseRightToLeft = value;
			}
		}
		/// <summary>
		...
		public string GlossFontFace
		{
			get
			{
				return m_sGlossFontFace;
			}
			set
			{
				m_sGlossFontFace = value;
			}
		}
		/// <summary>
		...
		public string LexFontFace
		{
			get
			{
				return m_sLexFontFace;
			}
			set
			{
				m_sLexFontFace = value;
			}
		}
		/// <summary>
		...
		public void SetTreeParameters(XmlDocument doc)
		{
			...
			SetColorFromXmlParameter(doc, "Fonts/Gloss/GlossColorName", "Fonts/Gloss/GlossColorArgb", out m_GlossColor, out m_iGlossColorArgb);
			...
			SetColorFromXmlParameter(doc, "Fonts/Lex/LexColorName", "Fonts/Lex/LexColorArgb", out m_LexColor, out m_iLexColorArgb);
			...
			SetColorFromXmlParameter(doc, "Fonts/NT/NTColorName", "Fonts/NT/NTColorArgb", out m_NTColor, out m_iNTColorArgb);

			LineWidth = GetXmlParameterAsDouble(doc, "Fonts/Lines/LineWidth");
			SetColorFromXmlParameter(doc, "Fonts/Lines/LinesColorName", "Fonts/Lines/LinesColorArgb", out m_LinesColor, out m_iLinesColorArgb);

			SetColorFromXmlParameter(doc, "Fonts/Background/BackgroundColorName", "Fonts/Background/BackgroundColorArgb", out m_BackgroundColor, out m_iBackgroundColorArgb);

			setFontsFromXml();
		}
		private void SetColorFromXmlParameter(XmlDocument doc, string sNameParameter, string sArgbParameter, out Color color, out int iColorArgb)
		{
